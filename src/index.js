...
document.addEventListener("DOMContentLoaded", () => {
  fetch("http://localhost:3000/beers")
    ...
    .then((data) => {
      ...
      // Display the beer details in the HTML
      ...
      document.getElementsByClassName("beer-description")[0].textContent =
        beerDescription;
    })
});

// Define the new beer object
...
const allBeers = [
 ...
 const beerData = allBeers.map(allBeers => {
...
const reviewsLabel = document.querySelector('review')
